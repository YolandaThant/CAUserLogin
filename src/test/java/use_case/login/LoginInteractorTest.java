...
public class LoginInteractorTest {
    ...
    public void successUserLoggedInTest() {
        ...
        // Task 2.2.4: Before the use case is executed, the current user should initially be null.
        ...
        // Task 2.2.4: Add an assertNull call just before the interactor.execute(inputData); call to make sure this is true.
        assertNull(userRepository.getCurrentUser());
